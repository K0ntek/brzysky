...
const Contact = () => {
  return (
    <div className=' my-10  grid lg:grid-cols-2 gap-6' id='contact'>
         ...
         <div className='w-full mx-auto max-w-[700px] lg:max-w-full  shadow-[0px_0px_20px_0px] shadow-black/10 rounded-[40px] p-6'>
         <h2 className=' font-montserrat text-xl font-[600] tracking-tight
                ...
                <h1 className=' font-montserrat text-4xl font-[700] mt-1 mb-6'>NAPISZ DO MNIE LUB ZGŁOŚ NIERUCHOMOŚĆ!</h1>
        ...
        <div className=' max-w-[700px] lg:max-w-full mx-auto bg-gradient-to-tr from-[#ff9352] to-[#db661d] rounded-[40px] p-10 shadow-[0px_0px_20px_0px] shadow-black/30'>
        <div className='relative top-[50%] translate-y-[-50%] mx-auto'>
            <div className=' space-y-3 font-montserrat font-[500]'>
            <h1 className=' font-montserrat text-4xl font-[600] text-center mt-1 mb-6'>Masz nieruchomość? Daj znać i postaram się pomóc!</h1>
                    ...
                    <div className=''>
                        ...
                        <p className=' ml-8'>examplemail@gmail.com</p>
                    </div>
                   ...
                   <div className=''>
                        ...
                        <p className=' ml-8'> +48 123 456 789</p>
                   </div>
