...
const About = () => {
  return (
    <div className=' w-full mx-auto bg-zinc-950 py-10 lg:rounded-3xl lg:my-6 mt-8 relative top-[-20px]' id='about'>
          <div className='w-5/6 py-7 mx-auto rounded-[40px]'>
              <h1 className=' text-7xl font-mont font-[200] text-center text-[silver] my-8'>O MNIE</h1>
