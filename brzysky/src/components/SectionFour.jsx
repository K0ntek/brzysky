    ...
    <div className=' grid lg:grid-cols-2 gap-10 my-10'>
        ...
        <div className=' max-w-[650px] mx-auto'>
            ...
            <h2 className=' font-montserrat text-xl font-[600] tracking-tight
                ...
                <h1 className=' font-montserrat text-3xl sm:text-4xl md:text-5xl font-[700] mt-1 mb-6 uppercase'>Doświadczenie</h1>
                <p className=' font-inter font-[500] text-xl sm:w-3/4 text-justify mb-2 mx-auto lg:mx-0'>
                Biegle znam procesy montażu i prezentacji nieruchomości, co umożliwia mi efektywne przygotowanie
                 ofert i maksymalne wykorzystanie ich potencjału.</p>
                    ...
                    <p className=' font-inter font-[500] text-xl sm:w-3/4 text-justify mb-8 mx-auto lg:mx-0'>
