    ...
    <div className=' grid lg:grid-cols-2 min-h-screen gap-10 py-[70px]' id='home'>
        ...
        <div className=' max-w-[700px] mx-auto'>
            <div className=' text-center lg:text-start relative top-[50%] translate-y-[-50%]'>
                ...
                <h1 className=' headerElement font-montserrat text-4xl md:text-7xl font-[600] mt-1 my-4'>PIOTR BRZYSKI</h1>
                ...
                <div className=" headerElement grid sm:flex gap-2 sm:gap-5 sm:space-y-0 mx-auto justify-center lg:justify-start mt-3">
                    <Link to='about' spy={true} smooth={true}><button className=' w-[200px] border-[2px] border-[#111] bg-[#111] text-white py-2 px-5 font-montserrat font-[600] rounded-lg hover:tracking-wider hover:font-[600] transition-all duration-150'>ZOBACZ WIĘCEJ</button></Link>
                    <Link to='offer' spy={true} smooth={true}><button className=' w-[190px] border-[2px] border-[#ff9352] bg-transparent text-[#ff9352] py-2 px-5 font-montserrat font-[600] rounded-lg hover:tracking-widest hover:font-[600] transition-all duration-150'>MOJA OFERTA</button></Link>
                </div>
                

            <div className=' w-4/5 flex flex-wrap justify-center mx-auto lg:mx-0 gap-2 mt-6'>
                <div className='descElement bg-[rgb(240,240,240)] sm:ml-0 text-black px-4 py-3 rounded-xl shadow-[0px_0px_10px_0px] shadow-black/30 min-w-[160px]'>
                    {/* <h3>Lorem, ipsum dolor.</h3> */}
                    <p className=' font-montserrat font-[600] text-center py-2'>Profesjonalizm</p>
                </div>
                <div className='descElement bg-zinc-950 sm:ml-0  px-4 py-3 rounded-xl text-white shadow-[0px_0px_10px_0px] shadow-black/30 min-w-[160px]'>
                    {/* <h3>Lorem, ipsum dolor.</h3> */}
                    <p className=' font-montserrat font-[600] text-center py-2'>Doświadczenie</p>
                </div>
                <div className='descElement bg-[#ff9352] sm:ml-0 px-4 py-3 rounded-xl shadow-[0px_0px_10px_0px] shadow-black/30 min-w-[160px]'>
                    {/* <h3>Lorem, ipsum dolor.</h3> */}
